...
class DbService {
    ...
    create = async (connectionName, modelName, payload) => {
        try {
            ...
            return Promise.reject({
                statusCode: STATUS_CODES.HTTP_INTERNAL_SERVER_ERROR,
                message: responseMessages[1213],
    ...
    find = async (connectionName, modelName, query = {}, fields = {}, populate = [], sort = {}, limit = 0, skip = 0) => {
        try {
    ...
    findOne = async (connectionName, modelName, query = {}, fields = {}, populate = [], sort = {}) => {
        try {
